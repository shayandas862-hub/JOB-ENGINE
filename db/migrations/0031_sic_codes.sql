-- 0031_sic_codes.sql
-- Reference table: official UK Standard Industrial Classification (SIC 2007)
-- condensed list as published by Companies House (resources.companieshouse.gov.uk/sic).
-- Lets sponsor_census.industry_codes be read in plain English. Reference
-- data only; the census write-path never touches this table.

create table if not exists sic_codes (
    code        text primary key,
    description text not null,
    source      text not null default 'companies_house_sic_2007'
);

insert into sic_codes (code, description) values
    ...
    ('93210', 'Operation of amusement parks and theme parks'),
